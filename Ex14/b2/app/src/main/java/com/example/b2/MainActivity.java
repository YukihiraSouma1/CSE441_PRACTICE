    ...
    private void addEvent() {
        tab.setOnTabChangedListener(tabId -> {
            switch (tabId) {
                case "t1":
                    if (list1.isEmpty()) {
                        list1.add(new Song("52300", "Em là của ngày hôm qua", true));
                        list1.add(new Song("52600", "Thiên lý ơi", true));
                        list1.add(new Song("52567", "Dấu mưa", true));
                        adapter1.notifyDataSetChanged();
                    }
                    break;
                case "t2":
                    list2.clear();
                    list2.add(new Song("57236", "Biển tình", false));
                    list2.add(new Song("51548", "Trái tim biết khóc", false));
                    adapter2.notifyDataSetChanged();
                    break;
                case "t3":
                    list3.clear();
                    list3.add(new Song("57689", "Điều anh biết", true));
                    list3.add(new Song("58716", "Không bằng", false));
